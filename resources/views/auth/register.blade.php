            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <form action="/admins/register" method="post">
                      ...
                      <svg class="icon">
                        <use
                            xlink:href="/admin/login/node_modules/@coreui/icons/sprites/free.svg#cil-lock-locked"></use>
                      </svg></span>
                                        <input class="form-control" type="password" placeholder="کلمه عبور"
                                               name="password">
                                    </div>
                                    {{--                                    @error('password')--}}
                                    {{--                                    <span style="color: red">{{$message}}</span>--}}
                            ...
                            <div class="card col-md-5 text-white bg-primary py-5">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="/admins/login">
                                            <button class="btn btn-lg btn-outline-light mt-3" type="button">وارد شوید
                                            </button>
                                        </a>
                                    </div>
                                </div>
