                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="my-account-wrap">
                            <form class="login-form" method="post" action="/cases/{{$item->id}}">
                                @csrf
                                <div class="item-wrap">
                                ...
                                <div class="item-wrap">
                                    ...
                                    <input type="number" id="room_number" name="room_number" value="{{$item->room_number}}">
                                </div>
                                <div class="item-wrap">
                                    <label>مساحت <span class="required">*</span></label>
                                    <input type="number" id="area" name="area" value="{{$item->v}}">
                                </div>
                                <div class="item-wrap">
                                    <label>تعداد پارکینگ <span class="required">*</span></label>
                                    <input type="number" id="parking_number" name="parking_number" value="{{$item->parking_number}}">
                                </div>
                                <div class="item-wrap">
                                    <label>تعداد سرویس بهداشتی <span class="required">*</span></label>
                                    <input type="number" id="bath_number" name="bath_number" value="{{$item->bath_number}}">
                                </div>
                                <div class="item-wrap">
                                ...
                                <div class="item-wrap">
                                    ...
                                    <input type="number" id="rent" name="rent" value="{{$item->rent}}">
                                </div>
                                <div class="item-wrap">
                                    <label>ودیعه <span class="required">*</span></label>
                                    <input type="number" id="deposit" name="deposit" value="{{$item->deposit}}">
                                </div>
                                <div class="item-wrap">
                                ...
                                <div class="item-wrap">
                                    ...
                                    <input type="file" id="avatar_path" name="avatar_path" value="{{$item->avatar_path}}">
                                </div>
